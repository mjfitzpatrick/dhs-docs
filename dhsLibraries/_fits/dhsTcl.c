...
static int dhsReadImageTcl ( ClientData clientData, Tcl_Interp *interp, int argc, char *argv[] ) {
    ...
    int ip = 0;
    /* check handle */
    if ( Tcl_GetInt(interp,argv[1],&ip) != TCL_OK ) {
...
static int dhsMetaDataTcl ( ClientData clientData, Tcl_Interp *interp, int argc, char *argv[] ) {
    ...
    /* check data list */
    if ( Tcl_SplitList(interp,argv[2],&lsArgcD,(CONST char ***)&lsArgvD)!=TCL_OK ) {
    ...
    if ( Tcl_SplitList(interp,argv[4],&lsArgcC,(CONST char ***)&lsArgvC)!=TCL_OK || lsArgcC!=4L ) {
    ...
    if ( Tcl_SplitList(interp,lsArgvC[2],&lsArgcF,(CONST char ***)&lsArgvF) != TCL_OK ) ierror = DHS_TCL_TRUE;
    if ( Tcl_SplitList(interp,lsArgvC[3],&lsArgcS,(CONST char ***)&lsArgvS) != TCL_OK ) ierror = DHS_TCL_TRUE;
    if ( ierror ) {
...
static int dhsPixelDataTcl ( ClientData clientData, Tcl_Interp *interp, int argc, char *argv[] ) {
    ...
    /* check configuration list */
    if ( Tcl_SplitList(interp,argv[4],&lsArgcC,(CONST char ***)&lsArgvC)!=TCL_OK || lsArgcC!=5L ) {
	...
	if ( Tcl_SplitList(interp,lsArgvD[ic],&lsArgcC,(CONST char ***)&lsArgvC) != TCL_OK ) {
...
static int dhsOpenExpTcl ( ClientData clientData, Tcl_Interp *interp, int argc, char *argv[] ) {
    ...
    /* check configuration list */
    if ( Tcl_SplitList(interp,argv[2],&lsArgc,(CONST char ***)&lsArgv)!=TCL_OK || lsArgc<5L ) {
